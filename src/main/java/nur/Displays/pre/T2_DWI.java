...
public class T2_DWI extends BorderPane {
    ...
    private Label imgTypeL = new Label("Choose an image type: ");

    private GridPane grid = new GridPane();
    private Button t2Button = new Button("T2");  //odkáže na stránku A_ChooseIMG
    private Button dwiButton = new Button("DWI");  //odkáže na stránku A_ChooseIMG
    ...
    public T2_DWI(){
        ...
        //main
        imgTypeL.setAlignment(Pos.CENTER);
        imgTypeL.setStyle(" -fx-text-fill: white; -fx-font-size: 17px;");

        t2Button.setMinWidth(150);
        t2Button.setMinHeight(100);
        t2Button.setStyle("-fx-background-color: dodgerblue; " +
                "-fx-text-fill: white; " +
                "-fx-font-size: 14px; " +
                ...
                "-fx-border-radius: 5px;");
        t2Button.setOnMouseEntered(e -> t2Button.setStyle("-fx-background-color: lightblue; " +
                "-fx-text-fill: white; " +
                "-fx-font-size: 14px; " +
                "-fx-padding: 10px 20px; " +
                "-fx-font-family: 'Calibri'; "+
                "-fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.6), 10, 0, 0, 0);" +
                "-fx-border-radius: 5px;"));
        t2Button.setOnMouseExited(e -> t2Button.setStyle("-fx-background-color: dodgerblue; " +
                "-fx-text-fill: white; " +
                "-fx-font-size: 14px; " +
                "-fx-padding: 10px 20px; " +
                "-fx-font-family: 'Calibri'; "+
        ...
        dwiButton.setMinHeight(100);
        dwiButton.setMinWidth(150);
        dwiButton.setStyle("-fx-background-color: dodgerblue; " +
                "-fx-text-fill: white; " +
                "-fx-font-size: 14px; " +
                "-fx-padding: 10px 20px; " +
                "-fx-font-family: 'Calibri'; "+
                "-fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.6), 10, 0, 0, 0);" +
                "-fx-border-radius: 5px;");
        dwiButton.setOnMouseEntered(e -> dwiButton.setStyle("-fx-background-color: lightblue; " +
                "-fx-text-fill: white; " +
                "-fx-font-size: 14px; " +
                "-fx-padding: 10px 20px; " +
                "-fx-font-family: 'Calibri'; "+
                "-fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.6), 10, 0, 0, 0);" +
                "-fx-border-radius: 5px;"));
        dwiButton.setOnMouseExited(e -> dwiButton.setStyle("-fx-background-color: dodgerblue; " +
                "-fx-text-fill: white; " +
                "-fx-font-size: 14px; " +
                "-fx-padding: 10px 20px; " +
                "-fx-font-family: 'Calibri'; "+
        ...
        grid.add(imgTypeL, 0, 0);
        grid.add(t2Button, 0,1);
        grid.add(dwiButton, 1, 1);
        grid.setVgap(50);
        grid.setHgap(20);
